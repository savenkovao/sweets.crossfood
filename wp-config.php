...
define( 'WPCACHEHOME', '/sata2/home/users/crossfood/www/sweets.crossfood.od.ua/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('DB_NAME', 'crossfood_d9io5');

/** Имя пользователя MySQL */
define('DB_USER', 'crossfood_d9io5');

/** Пароль к базе данных MySQL */
define('DB_PASSWORD', 'G91Ju2cik');
